...
if __name__ == '__main__':
    ...
    X, Y, FeaturesAll, FeaturesReduced, system = library2.ReadFeatures('Harmonic Features.csv', \
...
#            idx.append(i)
    ...
    #        Model=1, Corr_Matrix=C, verbose=False)
        ...
        idx_alternative = library3.FindBestSet(x_std, y_std, idx_backward, idx_corr, VIP_idx=VIP_idx, Method='MSE', verbose=True)
