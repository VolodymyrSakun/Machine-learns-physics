...
def generate_molecule_coordinates_list(prototype, nMolecules=2, nRecords=100,\
        InnerRadius=0, OuterRadius=10, additional_gap=0, PrototypeFirst=False,\
        max_gen_trials=10, max_inner_trials=100, max_outer_trials=10,\
        verbose=False, n_verbose=10):
