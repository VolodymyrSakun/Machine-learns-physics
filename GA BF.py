#Genetic + Backward sequential + Best Set
...
EliteFraction = 0.5 # fracrion of good chromosomes that will be used for crossover
...
idx = [12, 24, 48, 18, 23]
nonzero_count, mse, rmse, r2, aIC = library2.get_fit_score(X_train, X_test, Y_train, Y_test, idx)
